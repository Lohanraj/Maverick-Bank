...
namespace MaverickBank.API.Services
{
    public class AuthService : IAuthService
    {
        ...
        public bool ForgotPassword(string email, out string? tempPassword)
        {
            tempPassword = null;
            try
            {
                ...
                string generated = "Temp@" + new Random().Next(100000, 999999);
                userEntity.PasswordHash = BCrypt.Net.BCrypt.HashPassword(generated);
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("An error occurred while resetting your password. Please try again.", ex);
            }
        }
    }
}
